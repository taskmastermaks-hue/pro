...
install_node 'comfyui-mickmumpitz-nodes' 'https://github.com/mickmumpitz/ComfyUI-Mickmumpitz-Nodes' 'numpy Pillow opencv-python' ''
...
install_node 'comfyui-gguf' 'https://github.com/city96/ComfyUI-GGUF' 'gguf' ''
install_node 'comfyui-preview360panorama' 'https://github.com/ProGamerGov/ComfyUI_preview360panorama' '' ''
install_node 'comfyui-olm-dragcrop' 'https://github.com/o-l-l-i/ComfyUI-Olm-DragCrop' '' ''

# === Component Node Dependencies (TASK-057) ===
# The following packs are only used inside Component Nodes (subgraphs).
# They may not be required if the component does not use them at runtime.
# Comment out any line to skip installation.
install_node 'comfyui-videohelpersuite' 'https://github.com/Kosinkadink/ComfyUI-VideoHelperSuite' 'opencv-python imageio-ffmpeg' ''  # subgraph-only
install_node 'comfyui-autocropfaces' 'https://github.com/liusida/ComfyUI-AutoCropFaces' '' ''  # subgraph-only
install_node 'res4lyf' 'https://github.com/ClownsharkBatwing/RES4LYF' '' ''  # subgraph-only
install_node 'rgthree-comfy' 'https://github.com/rgthree/rgthree-comfy' '' ''  # subgraph-only
...
download_hf 'nomadoor/flux-2-klein-9B-360-erp-outpaint-lora' 'flux-2-klein-9B-360-erp-outpaint-lora_V1.safetensors' "$COMFY/"'models/loras'
download_hf 'ApacheOne/FLUX.2-klein-9b-kv-nvfp4_mixed' 'flux2-klein-9b-kv-nvfp4.safetensors' "$COMFY/"'models/loras'
download_hf 'Lokosoto/Pub' 'ltx-2.3-22b-distilled-lora-384-1.1.safetensors' "$COMFY/"'models/loras'
download_hf 'Comfy-Org/ltx-2.3' 'split_files/loras/ltx-2.3-id-lora-talkvid-3k.safetensors' "$COMFY/"'models/loras'
download_hf 'Comfy-Org/flux2-dev' 'split_files/vae/flux2-vae.safetensors' "$COMFY/"'models/vae'
download_civitai 'https://civitai.com/api/download/models/2892069' "$COMFY/"'models/vae' 'LTX23_audio_vae_bf16.safetensors'
# WARNING: LTX23_video_vae_bf16.safetensors shares downloadUrl with ltx23_audio_vae_bf16.safetensors — possible registry bug, downloading both
download_civitai 'https://civitai.com/api/download/models/2892069' "$COMFY/"'models/vae' 'LTX23_video_vae_bf16.safetensors'
download_hf 'Lightricks/LTX-2.3' 'ltx-2.3-spatial-upscaler-x2-1.1.safetensors' "$COMFY/"'models/latent_upscale_models'
download_hf 'Comfy-Org/flux2-klein-9B' 'split_files/text_encoders/qwen_3_8b_fp8mixed.safetensors' "$COMFY/"'models/clip'
download_hf 'Comfy-Org/ltx-2' 'split_files/text_encoders/gemma_3_12B_it_fp8_scaled.safetensors' "$COMFY/"'models/clip'
download_hf 'Kijai/LTX2.3_comfy' 'text_encoders/ltx-2.3_text_projection_bf16.safetensors' "$COMFY/"'models/clip'
download_hf 'black-forest-labs/FLUX.2-klein-9b-fp8' 'flux-2-klein-9b-fp8.safetensors' "$COMFY/"'models/diffusion_models'
download_hf 'Kijai/LTXV2_comfy' 'diffusion_models/ltx-2-19b-dev-fp8_transformer_only.safetensors' "$COMFY/"'models/diffusion_models' 'ltx-2.3-22b-dev_transformer_only_fp8_scaled.safetensors'
download_hf 'QuantStack/LTX-2.3-GGUF' 'LTX-2.3-dev/LTX-2.3-dev-Q4_K_S.gguf' "$COMFY/"'models/diffusion_models'

# === Verify Downloads (KB 1.7) ===
echo -e "\n=== Verifying model files ==="
verify_model "$COMFY/"'models/loras/flux-2-klein-9B-360-erp-outpaint-lora_V1.safetensors' 'flux-2-klein-9B-360-erp-outpaint-lora_V1.safetensors'
verify_model "$COMFY/"'models/loras/flux2-klein-9b-kv-nvfp4.safetensors' 'flux2-klein-9b-kv-nvfp4.safetensors'
verify_model "$COMFY/"'models/loras/ltx-2.3-22b-distilled-lora-384-1.1.safetensors' 'ltx-2.3-22b-distilled-lora-384-1.1.safetensors'
verify_model "$COMFY/"'models/loras/ltx-2.3-id-lora-talkvid-3k.safetensors' 'ltx-2.3-id-lora-talkvid-3k.safetensors'
verify_model "$COMFY/"'models/vae/flux2-vae.safetensors' 'flux2-vae.safetensors'
verify_model "$COMFY/"'models/vae/LTX23_audio_vae_bf16.safetensors' 'LTX23_audio_vae_bf16.safetensors'
verify_model "$COMFY/"'models/vae/LTX23_video_vae_bf16.safetensors' 'LTX23_video_vae_bf16.safetensors'
verify_model "$COMFY/"'models/latent_upscale_models/ltx-2.3-spatial-upscaler-x2-1.1.safetensors' 'ltx-2.3-spatial-upscaler-x2-1.1.safetensors'
verify_model "$COMFY/"'models/clip/qwen_3_8b_fp8mixed.safetensors' 'qwen_3_8b_fp8mixed.safetensors'
verify_model "$COMFY/"'models/clip/gemma_3_12B_it_fp8_scaled.safetensors' 'gemma_3_12B_it_fp8_scaled.safetensors'
verify_model "$COMFY/"'models/clip/ltx-2.3_text_projection_bf16.safetensors' 'ltx-2.3_text_projection_bf16.safetensors'
verify_model "$COMFY/"'models/diffusion_models/flux-2-klein-9b-fp8.safetensors' 'flux-2-klein-9b-fp8.safetensors'
verify_model "$COMFY/"'models/diffusion_models/ltx-2.3-22b-dev_transformer_only_fp8_scaled.safetensors' 'ltx-2.3-22b-dev_transformer_only_fp8_scaled.safetensors'
verify_model "$COMFY/"'models/diffusion_models/LTX-2.3-dev-Q4_K_S.gguf' 'LTX-2.3-dev-Q4_K_S.gguf'
