...
download_hf 'Kijai/WanVideo_comfy' 'LoRAs/Wan22_relight/WanAnimate_relight_lora_fp16.safetensors' "$COMFY/"'models/loras'
download_hf 'Kijai/WanVideo_comfy' 'Lightx2v/lightx2v_I2V_14B_480p_cfg_step_distill_rank128_bf16.safetensors' "$COMFY/"'models/loras'
download_hf 'Kijai/WanVideo_comfy' 'Wan2_1_VAE_bf16.safetensors' "$COMFY/"'models/vae'
download_hf 'Kijai/WanVideo_comfy' 'umt5-xxl-enc-bf16.safetensors' "$COMFY/"'models/clip'
download_hf 'Comfy-Org/Wan_2.2_ComfyUI_repackaged' 'split_files/diffusion_models/wan2.2_animate_14B_bf16.safetensors' "$COMFY/"'models/diffusion_models'
download_hf 'JoMun/vitpose-l-wholebody' 'vitpose-l-wholebody.onnx' "$COMFY/"'models/detection'
download_hf 'Ludka8008/co-wan-m' 'models/detection/yolov10m.onnx' "$COMFY/"'models/detection'

# === Verify Downloads (KB 1.7) ===
echo -e "\n=== Verifying model files ==="
verify_model "$COMFY/"'models/loras/WanAnimate_relight_lora_fp16.safetensors' 'WanAnimate_relight_lora_fp16.safetensors'
verify_model "$COMFY/"'models/loras/lightx2v_I2V_14B_480p_cfg_step_distill_rank128_bf16.safetensors' 'lightx2v_I2V_14B_480p_cfg_step_distill_rank128_bf16.safetensors'
verify_model "$COMFY/"'models/vae/Wan2_1_VAE_bf16.safetensors' 'Wan2_1_VAE_bf16.safetensors'
verify_model "$COMFY/"'models/clip/umt5-xxl-enc-bf16.safetensors' 'umt5-xxl-enc-bf16.safetensors'
verify_model "$COMFY/"'models/diffusion_models/wan2.2_animate_14B_bf16.safetensors' 'wan2.2_animate_14B_bf16.safetensors'
verify_model "$COMFY/"'models/detection/vitpose-l-wholebody.onnx' 'vitpose-l-wholebody.onnx'
