...
install_node 'new-utils' 'https://github.com/teskor-hub/NEW-UTILS' '' ''
install_node 'comfyui-load-lora-from-url' 'https://github.com/bollerdominik/ComfyUI-load-lora-from-url' '' ''
...
download_hf 'Kijai/WanVideo_comfy' 'Lightx2v/lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16.safetensors' "$COMFY/"'models/loras'
download_hf 'lightx2v/Wan2.2-Lightning' 'Wan2.2-I2V-A14B-4steps-lora-rank64-Seko-V1/low_noise_model.safetensors' "$COMFY/"'models/loras'
download_hf 'Kijai/WanVideo_comfy' 'Pusa/Wan21_PusaV1_LoRA_14B_rank512_bf16.safetensors' "$COMFY/"'models/loras'
download_hf 'dci05049/Wan2.2-Fun-A14B-InP-low-noise-HPS2.1.safetensors' 'Wan2.2-Fun-A14B-InP-low-noise-HPS2.1.safetensors' "$COMFY/"'models/loras' "" 'https://civitai.com/api/download/models/2211812'
download_civitai 'https://civitai.com/api/download/models/2191270' "$COMFY/"'models/loras' 'BounceLowWan2_2.safetensors'
download_hf 'Comfy-Org/Wan_2.1_ComfyUI_repackaged' 'split_files/vae/wan_2.1_vae.safetensors' "$COMFY/"'models/vae'
download_hf 'Comfy-Org/Wan_2.1_ComfyUI_repackaged' 'split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors' "$COMFY/"'models/clip'
download_hf 'Comfy-Org/Wan_2.1_ComfyUI_repackaged' 'split_files/clip_vision/clip_vision_h.safetensors' "$COMFY/"'models/clip_vision'
download_hf 'Kijai/WanVideo_comfy_fp8_scaled' 'Wan22Animate/Wan2_2-Animate-14B_fp8_scaled_e4m3fn_KJ_v2.safetensors' "$COMFY/"'models/diffusion_models'
download_hf 'Kijai/vitpose_comfy' 'onnx/vitpose_h_wholebody_model.onnx' "$COMFY/"'models/detection'
download_hf 'Kijai/vitpose_comfy' 'onnx/vitpose_h_wholebody_data.bin' "$COMFY/"'models/detection'
download_hf 'Wan-AI/Wan2.2-Animate-14B' 'process_checkpoint/det/yolov10m.onnx' "$COMFY/"'models/detection'
download_hf 'Kijai/WanVideo_comfy' 'Wan21_Uni3C_controlnet_fp16.safetensors' "$COMFY/"'models/controlnet'

# === Verify Downloads (KB 1.7) ===
echo -e "\n=== Verifying model files ==="
verify_model "$COMFY/"'models/loras/lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16.safetensors' 'lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16.safetensors'
verify_model "$COMFY/"'models/loras/low_noise_model.safetensors' 'low_noise_model.safetensors'
verify_model "$COMFY/"'models/loras/Wan21_PusaV1_LoRA_14B_rank512_bf16.safetensors' 'Wan21_PusaV1_LoRA_14B_rank512_bf16.safetensors'
verify_model "$COMFY/"'models/loras/Wan2.2-Fun-A14B-InP-low-noise-HPS2.1.safetensors' 'Wan2.2-Fun-A14B-InP-low-noise-HPS2.1.safetensors'
verify_model "$COMFY/"'models/loras/BounceLowWan2_2.safetensors' 'BounceLowWan2_2.safetensors'
verify_model "$COMFY/"'models/vae/wan_2.1_vae.safetensors' 'wan_2.1_vae.safetensors'
verify_model "$COMFY/"'models/clip/umt5_xxl_fp8_e4m3fn_scaled.safetensors' 'umt5_xxl_fp8_e4m3fn_scaled.safetensors'
verify_model "$COMFY/"'models/clip_vision/clip_vision_h.safetensors' 'clip_vision_h.safetensors'
verify_model "$COMFY/"'models/diffusion_models/Wan2_2-Animate-14B_fp8_scaled_e4m3fn_KJ_v2.safetensors' 'Wan2_2-Animate-14B_fp8_scaled_e4m3fn_KJ_v2.safetensors'
